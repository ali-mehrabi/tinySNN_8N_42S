...
add wave -noupdate /network_tb/u_network_test/u_network/u_feast_train/r_w
...
add wave -noupdate /network_tb/u_network_test/u_network/u_feast_train/w_lv
...
add wave -noupdate -color Yellow -format Analog-Step -height 100 -itemcolor Yellow -max 100.0 /network_tb/avg
...
add wave -noupdate /network_tb/r_cnt
add wave -noupdate /network_tb/r_avg
add wave -noupdate /network_tb/avg
add wave -noupdate /network_tb/r_state
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {4620133 ns} 0}
...
update
WaveRestoreZoom {616591 ns} {33455255 ns}
